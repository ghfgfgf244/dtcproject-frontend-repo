  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Other Documents</h3>
      </div>
      <div className={styles.cardsGrid}>
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-primary/50 transition-all group">
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="px-2.5 py-1 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-[10px] font-bold uppercase tracking-wider">Verified</span>
          </div>
          <h4 className="font-bold text-slate-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Medical_Clearance.pdf</h4>
          <div className="flex flex-col gap-1 text-sm text-slate-500 dark:text-slate-400">
            <span>Uploaded: Aug 12, 2023</span>
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-primary/50 transition-all group">
          ...
          <h4 className="font-bold text-slate-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Insurance_Policy_24.pdf</h4>
          <div className="flex flex-col gap-1 text-sm text-slate-500 dark:text-slate-400">
            <span>Uploaded: Dec 01, 2023</span>
        ...
        <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl flex flex-col items-center justify-center p-8 hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-all cursor-pointer group">
          ...
          <p className="font-bold text-slate-400 group-hover:text-primary transition-colors">Add Document</p>
        </div>
