        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
              <div>
                <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                  <User className="w-3.5 h-3.5" /> Thong tin hoc vien
                </h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase">So dien thoai</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase">Ngay dang ky</p>
                  ...
                  <div className="space-y-3 rounded-xl border border-sky-100 bg-sky-50/70 p-4">
                    ...
                    {registration.assignedTermName && (
                      <div className="text-xs text-slate-600">
                        <span className="font-bold text-slate-800">Ky da xep:</span> {registration.assignedTermName}
                      </div>
                    )}
                    {registration.assignedClassName && (
                      <div className="text-xs text-slate-600">
                        <span className="font-bold text-slate-800">Lop da xep:</span> {registration.assignedClassName}
                      </div>
                    )}
                    {!registration.assignedTermName && registration.suggestedTermName && (
                      <div className="text-xs text-slate-600">
                        <span className="font-bold text-slate-800">Ky du kien gan nhat:</span> {registration.suggestedTermName}
                      </div>
                    )}
                  </div>
                </div>
              ...
              {registration.notes && (
                <div className="pt-6 border-t border-slate-100">
                  <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                    <FileText className="w-3.5 h-3.5" /> Ghi chu
                  </h3>
            ...
            <div className="lg:col-span-2">
              <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                <ImageIcon className="w-3.5 h-3.5" /> Ho so hinh anh
              </h3>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <p className="text-[10px] font-black text-slate-500 uppercase tracking-tighter ml-1">Anh ho so</p>
                  <div className="aspect-[3/4] bg-slate-100 rounded-xl border-2 border-slate-100 overflow-hidden relative group">
                    {registration.photoUrl ? (
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-300">
                        ...
                        <span className="text-[10px] font-bold">Chua co anh</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-tighter ml-1">CCCD mat truoc</p>
                  ...
                  <div className="space-y-2">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-tighter ml-1">CCCD mat sau</p>
                    <div className="aspect-[1.6/1] bg-slate-100 rounded-xl border-2 border-slate-100 overflow-hidden relative group">
