...
const breadcrumbItems = [
    ...
    { label: 'Exam Management', href: '/training-manager/exams' }, // Link ngược về trang quản lý đợt thi
    { label: 'Exam Results' } // Trang hiện tại
  ];
  return (
    <div className="p-8">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-[30px] font-black tracking-tighter text-slate-900 uppercase">Exam Results Management</h2>
          <p className="text-slate-500 font-medium text-sm mt-1">Reviewing performance metrics for Q3 Certification Cycle</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 font-bold text-sm rounded-lg shadow-sm active:scale-95 transition-all">
            <Share className="w-4 h-4" /> Export Dataset
          </button>
        </div>
      </div>
