...
export default async function CourseDetail({ params }: PageProps) {
  ...
  try {
    ...
    console.error(
      `DTC: [Server] Critical error fetching course ${id}:`,
      err.message || err,
    );
  }
      ...
      <div className="max-w-6xl mx-auto p-8 grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <ul className="space-y-2 text-slate-600">
              ...
              <li>
                📅 Thời gian đào tạo: {course.durationInWeeks || "3-6"} tuần
              </li>
          ...
          {/* Roadmap */}
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <h2 className="text-xl font-semibold mb-4">Lộ trình học</h2>
          ...
          {/* Policy */}
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <h2 className="text-xl font-semibold mb-4">Chính sách & Cam kết</h2>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 text-center shadow-sm">
            <h3 className="font-semibold mb-3">Trung tâm đào tạo</h3>
            ...
            <Link
              href={`/centers/${course.centerId}`}
              className="text-xs text-sky-600 hover:underline mt-4 block"
            >
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 text-center shadow-sm">
            <h3 className="font-semibold mb-3">Hỗ trợ tư vấn</h3>

            <p className="text-slate-600 text-sm">Hotline: 0900 000 000</p>
