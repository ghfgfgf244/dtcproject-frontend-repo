...
const API_BASE_URL = (
  process.env.NEXT_PUBLIC_API_URL || "http://localhost:5066/api"
).replace(/\/+$/, "");
    ...
    <div className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p>
            Đăng ký tham gia các trung tâm đào tạo đáng tin cậy và xây dựng sự
            tự tin lái xe thực tế cho mọi hành trình.
          </p>
        </div>
      </section>
