...
// FIX: "B2" is not a valid ExamLevelLabel — the closest equivalent is "B" (hạng B).
//      Mapped: B2 -> "B", B1 -> "B1", A1 -> "A1", C -> "C"
export const MOCK_COURSES: CourseRecord[] = [
  { id: "crs-1", name: "Đào tạo Lái xe ô tô hạng B2 (Tiêu chuẩn)", description: "20 buổi thực hành • 1 kèm 1", licenseType: "B", price: 14500000, status: "Hoạt động" },
  ...
  { id: "crs-5", name: "Khóa bổ túc tay lái B2 (Cuối tuần)", description: "10 buổi thực hành • Lịch linh hoạt", licenseType: "B", price: 8000000, status: "Hoạt động" },
